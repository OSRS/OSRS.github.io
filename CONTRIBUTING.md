...
Project maintainers will merge changes that improve the product significantly and broadly and that align with the [OSRS Open Roadmap](https://osrs.github.io/roadmap.md).
...
* **DON'T** surprise us with big pull requests. Instead, file an issue and start
  ...
  of time.
* **DON'T** commit code that you didn't write. If you find code that you think is a good fit to add to an OSRS Open project, file an issue and start a discussion before proceeding.
...
For any specific OSRS Open project, the up for grabs issues will be in the specific project.
The team marks the most straightforward issues as [up for grabs](https://github.com/OSRS/OSRS.github.io/labels/up-for-grabs). This set of issues is the place to start if you are interested in contributing but new to the codebase.
